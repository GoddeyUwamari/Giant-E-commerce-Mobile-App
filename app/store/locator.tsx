...
const mockStores: Store[] = [
    ...
    },
    {
        ...
        name: 'Walmart Supercenter',
        address: {
            street: '3412 College Ave',
            city: 'San Diego',
            state: 'CA',
            zipCode: '92115',
            fullAddress: '3412 College Ave, San Diego, CA 92115',
        },
        phone: '(619) 265-4321',
        coordinates: { latitude: 32.7574, longitude: -117.0719 },
        distance: 4.8,
        rating: 4.3,
        reviewCount: 1245,
        isOpen: true,
        ...
        storeType: 'Supercenter',
        features: ['24/7 ATM', 'Garden Center', 'Photo Center', 'Subway'],
    },
    {
        id: 'store_6',
        name: 'Walmart Neighborhood Market',
        address: {
            ...
            state: 'CA',
            zipCode: '91911',
            fullAddress: '1240 Broadway, Chula Vista, CA 91911',
        },
        phone: '(619) 422-1234',
        ...
        services: ['Pharmacy', 'Grocery Pickup'],
        storeType: 'Neighborhood Market',
        features: ['Fresh Produce', 'Deli', 'Bakery', 'Floral'],
    },
];
...
export default function StoreLocatorScreen(): JSX.Element {
